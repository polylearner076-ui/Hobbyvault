...
export const AUDIT_ASSETS = [
  {
    ...
    category: 'pokemon',
    condition: 'PSA_10',
    vaultPriceUSD: 368.80,
    expectedRange: [300, 650],
    expectedSource: 'TCGPlayer Market Index (Live Official)',
  },
  {
    id: 'poke-02',
    ...
    category: 'pokemon',
    condition: 'PSA_10',
    vaultPriceUSD: 2244.50,
    expectedRange: [1800, 3500],
    expectedSource: 'TCGPlayer Market Index (Live Official)',
  },
  {
    id: 'poke-03',
    ...
    category: 'pokemon',
    condition: 'RAW_NM',
    vaultPriceUSD: 1098.70,
    expectedRange: [850, 1600],
    expectedSource: 'TCGPlayer Market Index (Live Official)',
  },
  {
    id: 'poke-04',
    ...
    category: 'pokemon',
    condition: 'CGC_10',
    vaultPriceUSD: 1048.09,
    expectedRange: [750, 1800],
    expectedSource: 'TCGPlayer Market Index (Live Official)',
  },
  {
    id: 'mtg-01',
